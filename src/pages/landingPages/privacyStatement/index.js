      ...
      <div className="wrapper w-full">
        ...
        <div className="my-5">
          ...
          <div className="px-[4%] flex flex-col gap-3 w-[85%]">
            ...
            <div className="text-headerColor font-normal text-base">
              ...
              subscribe to newsletters on our website. We may also automatically collect some technical information when
              you visit our website such as your IP address, and information about your visit, such as the pages that
              you viewed. This information helps us understand customer interests and helps us improve our website. When
              you visit our site, the pages that you look at, and a short text file called a cookie, are downloaded to
              your computer. By visiting and using our website, you agree to our use of cookies in line with United
              Capital’s policies. For more details about Cookies, please read our Cookies Policy available through this{" "}
              <a
            ...
            <Text weight="normal" variant="h4" color="text-headerColor">
              ...
              purposes. However, we may share your Personal Data with companies within the United Capital Group, service
              providers engaged by us to provide services to United Capital subject to appropriate data security and
              protection. We may also share your information where there is a regulatory or statutory obligation to
            ...
            <Text weight="normal" variant="h4" color="text-headerColor">
              ...
              processed for the minimum period necessary in line with the purposes set out in this Notice or as required
              by applicable laws, until a time it is no longer required or has no use. Once your Personal Data is no
            ...
            <div>
              ...
              <div className="mt-2 flex flex-col gap-2 w-full ml-[2%]">
                <p className="text-headerColor font-normal text-base">
                ...
                <p className="text-headerColor font-normal text-base">d) request for deletion of your Personal Data;</p>
                <p className="text-headerColor font-normal text-base">
            ...
            <Text weight="normal" variant="h4" color="text-headerColor">
              ...
              policies or update this Notice from time to time. You will always be able to find the most recent version
              of our updated privacy policy on this site.
            </Text>
            <Text weight="bold" variant="h3" color="text-headerColor">
            ...
            <Text weight="normal" variant="h4" color="text-headerColor">
              ...
              contact us at United Capital, United Capital Plc, 3rd and 4th Floor, Afriland Towers, 97/105 Broad Street,
              Lagos., Nigeria or at dpo@unitedcapitalplcgroup.com.
            </Text>
          </div>
          {/* // )} */}
        </div>
