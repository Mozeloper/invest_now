        ...
        <div className="my-10">
          ...
          {isActive?.privacy_policy && (
            <div className="px-[4%] flex flex-col gap-3 w-[85%]">
              ...
              <Text weight="normal" variant="body" color="text-headerColor">
                We Collect We collect Personal Data that you give to us, for example, where you create an account with
                us, request for further information about our product, fill a form, apply for a job through our website
                or you subscribe to newsletters on our website. We may also automatically collect some technical
                information when you visit our website such as your IP address, and information about your visit, such
                as the pages that you viewed. This information helps us understand customer interests and helps us
                improve our website. When you visit our site, the pages that you look at, and a short text file called a
                cookie, are downloaded to your computer. By visiting and using our website, you agree to our use of
                cookies in line with United Capital’s policies. For more details about Cookies, please read our Cookies
                Policy available through this link.
              </Text>
              <Text weight="bold" variant="h4" color="text-headerColor">
              ...
              <Text weight="normal" variant="body" color="text-headerColor">
                ...
                obligation to disclose such Personal Data in accordance with provisions of applicable laws. Security and
                Retention of your Personal Data Your Personal Data is kept private and We make every effort to keep your
                Personal Data secure, including restricting access to your Personal Data with us on a need to know
                basis. We require our staff and any third parties who carry out any work on our behalf to comply with
                appropriate security standards to protect your Personal Data. We take appropriate measures to ensure
                that your Personal Data is only processed for the minimum period necessary in line with the purposes set
                out in this Notice or as required by applicable laws, until a time it is no longer required or has no
                use. Once your Personal Data is no longer required, we destroy it in a safe and secure manner. Your
                Rights United Capital collects Personal Data only for the purposes identified in this Policy You can
                exercise the following rights with respect to your Personal Data with United Capital: a) request for and
                access your Personal Data collected and stored by United Capital; and such information cannot be reused
                for another purpose that is incompatible with the original purpose. b) withdraw consent at any time. For
                example, you can withdraw your consent to receipt of our marketing or promotional materials or
                unsubscribe to our newsletters; c) object to automated decision making; request rectification and
                modification of Personal Data kept by United Capital ; d) request for deletion of your Personal Data; e)
                be informed of and entitled to provide consent prior to the processing of Personal Data for purposes
                other than that for which the Personal Data were collected; f) request that United Capital restricts
                processing of your Personal Data; and g) request for information regarding any specific processing of
                your personal data. Changes to our Privacy Notice Due to constant changes in technology and regulatory
                requirements, we may need to change our privacy policies or update this Notice from time to time. You
                will always be able to find the most recent version of our updated privacy policy on this site. Contact
                & Communication If you would like further information on this Notice, or to contact our Data Protection
                Officer, you may contact us at United Capital, United Capital Plc, 3rd and 4th Floor, Afriland Towers,
                97/105 Broad Street, Lagos., Nigeria or at dpo@unitedcapitalplcgroup.com. */
              </Text>
            </div>
          )}
        </div>
